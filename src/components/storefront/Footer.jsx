...
const Footer = () => {
  return (
    <footer style={{ 
      ...
      <div className="container footer-container" style={{ maxWidth: '600px', margin: '0 auto' }}>
        
        <div className="footer-top-wrapper">
          {/* Brand & Socials */}
          <div className="footer-brand-col" style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            <h2 style={{ 
            ...
            <p style={{ color: '#706F65', fontSize: '0.82rem', lineHeight: 1.7, maxWidth: '320px', margin: '0 auto 1.5rem' }}>
          ...
          <div className="hide-on-desktop" style={{ height: '1px', background: 'linear-gradient(to right, transparent, #D4CFC5, transparent)', margin: '0 0 2rem 0' }} />
